package com.lufax.foudation.statemachine.fsm.util;
...
public class ReflectUtils {
    ...
    private static Field getField(Class<?> clazz, String fieldName, Class<?> original) {
        ...
        try {
            ...
            throw new StateMachineException(e, ErrorCodes.NOT_ALLOW_ACCESS_FIELD, getClassNameSafe(clazz), fieldName);
        } catch (NoSuchFieldException e) {
            if (clazz.getSuperclass()!=null) {
                return getField(clazz.getSuperclass(), fieldName, original);
            } else {
                throw new StateMachineException(e, ErrorCodes.FIELD_NOT_FOUND, original.getName(), fieldName);
            }
        }
        return field;
    }
    ...
    private static Method getMethod(Class<?> clazz, String methodName, Class<?>[] parameterTypes, Class<?> original) {
        ...
        try {
            ...
            throw new StateMachineException(e, ErrorCodes.NOT_ALLOW_ACCESS_METHOD, getClassNameSafe(clazz), methodName, getParameterTypesText(parameterTypes));
        } catch (NoSuchMethodException e) {
            if (clazz.getSuperclass()!=null) {
                return getMethod(clazz.getSuperclass(), methodName, parameterTypes, original);
            } else {
                throw new StateMachineException(e, ErrorCodes.METHOD_NOT_FOUND, original.getName(), methodName, getParameterTypesText(parameterTypes));
            }
        }
        return method;
    }
    ...
    public static <T> Constructor<T> getConstructor(Class<T> type, Class<?>[] parameterTypes) {
        try {
            ...
            throw new StateMachineException(e, ErrorCodes.CONSTRUCTOR_NOT_FOUND,
    ...
    private static <T> T newInstance(Class<T> clazz, Constructor<T> constructor, Object[] args) {
        ...
        try {
            ...
            throw new StateMachineException(cause, ErrorCodes.CONSTRUCT_NEW_INSTANCE_ERROR, getClassNameSafe(clazz), Arrays.toString(args));
        } finally {
    ...
    public static Object get(Field field, Object object) {
        if (field==null) {
            throw new StateMachineException(ErrorCodes.FIELD_NULL);
        }
        ...
        try {
            ...
            throw new StateMachineException(e, ErrorCodes.CANNOT_GET_FIELD_VALUE, field.getName());
        } finally {
    ...
    public static void set(Field field, Object object, Object value) {
        ...
        try {
            ...
            throw new StateMachineException(e, ErrorCodes.CANNOT_SET_FIELD_VALUE, field.getName(), value);
        } finally {
            field.setAccessible(oldAccessible);
        }
    }
    ...
    public static Object invoke(Method method, Object target, Object[] args) {
        if (method==null) {
            throw new StateMachineException(ErrorCodes.METHOD_NULL);
        }
        ...
        try {
            ...
            throw new StateMachineException(targetException, ErrorCodes.METHOD_INVOKE_ERROR,
                    method, Arrays.toString(args), target, targetException.getCause());
        } catch (Exception e) {
            throw new StateMachineException(e, ErrorCodes.METHOD_INVOKE_ERROR,
    ...
    public static String getPackageName(final String className) {
        if (className==null || className.length() == 0)
            throw new StateMachineException(ErrorCodes.ILLEGAL_CLASS_NAME);
    ...
    public static Class<?> getClass(final String className) {
        ...
        try {
            ...
            throw new StateMachineException(e, ErrorCodes.CLASS_NOT_FOUND, className);
        }
    }
